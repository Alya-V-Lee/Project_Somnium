...
void FMainGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Attributes_Primary_Constitution = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Primary.Constitution"), FString("Increases Health"));
	...
	GameplayTags.Attributes_Secondary_CriticalHitChance = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Secondary.CriticalHitChance"), FString("Chance to double damage with Critical Hit Damage bonus"));
	GameplayTags.Attributes_Secondary_CriticalHitDamage = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Secondary.CriticalHitDamage"), FString("Bonus damage added when a Critical Hit occurs"));
	...
	*/
	...
	GameplayTags.Damage_Force = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Damage.Force"), FString("Force Damage Type"));
	...
	*/
	...
	GameplayTags.Debuff_Force = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Debuff.Force"), FString("Debuff for Force Damage"));
	...
	*/
	...
	GameplayTags.DamageTypesToResistances.Add(GameplayTags.Damage_Force, GameplayTags.Attributes_Resistance_Force);
	...
	*/
	...
	GameplayTags.DamageTypesToDebuffs.Add(GameplayTags.Damage_Force, GameplayTags.Debuff_Force);
	...
	*/	
	...
	GameplayTags.Abilities_None = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Abilities.None"), FString("No ability, nullptr equivalent for Ability Tags."));
